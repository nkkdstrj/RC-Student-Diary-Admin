...
function Addsubbtn   ({ onSave, onClose, AddSubButton,handleClickInsideDropdown })  {
...
const stylebtn={
  ...
  const handleUpload = () => {
    ...
    if (!subButtonName && !selectedFile ) {
      setErrorname('Please input a sub button namee.');
      return;
    }
  ...
  }} className="dropdown-item" style={{ border: 'none', color: 'black', }}>
        Add Sub Button
      </button>
