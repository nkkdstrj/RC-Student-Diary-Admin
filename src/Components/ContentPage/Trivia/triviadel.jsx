...
function Triviadel({ titlecontent, handleDelete }) {
  ...
  return (
    <>
      <button onClick={handleShow} className="btn text-secondary" style={{ fontSize: "15px", padding: '0px', marginLeft: '5px' }}>
      ...
      >
        ...
        <Modal.Body className="text-center"W
          style={{
        ...
        >
          <h1>Delete Trivia</h1>
          <p>Deleting Trivia is permanent and cannot be undone</p>
        </Modal.Body>
        <Modal.Footer
          style={{
            backgroundColor: 'white',
